...
Работает только в Telegram и только в группе обсуждения. Посты канала не
распознаются, MAX не подключён вовсе — в MAX расшифровка встроена в клиент
(кнопка «Т» без подписки), в Telegram она есть только по Premium. Платить
провайдеру за то, что мессенджер делает бесплатно, смысла нет.
