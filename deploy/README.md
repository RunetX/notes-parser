...
владельца короткое нравоучение под каждой новой заметкой сайта — и старается
успеть первой: первый чужой комментарий приходит через медианные 164 секунды, а
весь наш путь (обнаружение, генерация, отправка) укладывается в 25–45.
