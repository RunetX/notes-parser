...
- Packages:
  ...
  - `pulpit` — «амвон»: собственная реплика владельца под каждой новой заметкой
    сайта, и по возможности первая. **Голос — прикольщик**: работа одна —
    рассмешить, и меняется форма (неожиданный вывод, буквально, ложная
    серьёзность, не та деталь, гипербола, самоирония, сценка, сочувствие с
    подвохом), а не голос. Первым голосом был проповедник, и он прожил ровно
