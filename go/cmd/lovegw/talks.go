...
//
// Обходятся только те, кто согласился на чтение переписки (`sessions.talks_scan`,
// кнопка «читать и присылать сюда» у бота): кнопок у CLI нет, спросить он не
// может, а читать чужие ЛС без спроса — то самое, от чего согласие и защищает.
