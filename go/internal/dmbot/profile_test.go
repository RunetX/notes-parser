...
func TestProfileAbsentWithoutCapableSite(t *testing.T) {
	...
	for _, c := range botCommands(false, true, false, true, true) {
		if c.Name == "profile" {
...
func TestProfileRejectedByTalksBot(t *testing.T) {
	...
	for _, c := range botCommands(true, true, true, true, true) {
		if c.Name == "profile" {
...
func TestProfileInMenus(t *testing.T) {
	var found bool
	for _, c := range botCommands(false, true, true, true, true) {
