...
//
// ЧЕТВЁРТЫЙ ДОКУМЕНТ — ЛИЧНАЯ ПЕРЕПИСКА (эпик L, 11.09.2026), и он тот же рычаг,
// применённый к куда более тяжёлому случаю. Переписка — это 149-ФЗ: хранение
// содержания полгода, метаданных год, выдача уполномоченным органам по запросу и
// отсутствие сквозного шифрования. Абзацем в общем документе такое не поместишь,
// а поместив — заставишь ПОДПИСАТЬСЯ ЗАНОВО всех до единого, включая тех, кто
// писем писать не собирается вовсе. Поэтому спрашивается оно у того, кто пишет
// или читает письмо, и ни у кого больше: не подписал — площадка для него
// прежняя, а пришедшее письмо просто лежит непоказанным (об этом сказано в самом
// документе).
var (
