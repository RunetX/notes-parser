...
//
// ЧЕГО ЗДЕСЬ НЕ ИЗМЕРИТЬ: саму вероятность «прийти в заметку» — её меряет
// сосед, `come_rate.go` (29.08.2026; прежде она числилась неизмеримой, и
// знаменатель у неё нашёлся). Здесь меряется не она, а ПЕРЕКОС:
