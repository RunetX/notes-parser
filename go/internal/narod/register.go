...
func applySmiley(s string, r Register, rng *rand.Rand) string {
	...
	// В карточке лежит ИМЯ смайла («crazy2»), а сайт понимает его только в
	// обёртке. Без неё на странице встаёт голое английское слово посреди русской
	// реплики — признак машины куда более явный, чем отсутствие смайла вовсе
	// (поймано на второй боевой песочнице: «слышать бы) agree»).
