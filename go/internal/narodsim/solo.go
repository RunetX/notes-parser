...
type SpeechPoint struct {
	...
	// Mood — с каким чувством житель пишет эту реплику: больное место, ступень
	// разговора с адресатом, регистр. Готовым блоком, как Memory, и по той же
	// причине: собирает его тот, у кого есть мир и карточка жителя.
	Mood string
}
